...
\usepackage{enumerate} %fÃƒÂ¼r beschriftete Nummerierung
\usepackage{multirow} %mehrere Zeilen zusammenfassen

\usepackage{makeidx} %fÃƒÂ¼rs Stichwortverzeichnis
...
\section{Simulation}
\begin{itemize}
\item Besprechung von Ausgaben der Optimierung für verschiedene Aenderungen von Gewichtungsgroeßen.
\end{itemize}

\section{Robuste Formulierung}
\begin{itemize}
\item Wie modellieren wir Constraints hervorgerufen durch den Verlauf der Straße mit dem Ansatz von Diehl?
...
\begin{itemize}
\item Johannes updated grobe Struktur des Projektplanes und weißt andere dazu auf ihre Aufgabengebiete genauer zu beschreiben
...
\item Wann ist unsere Präsentation?
\item Können wir die Plots von Sebastians Präsentation verwenden?
\end{itemize}
