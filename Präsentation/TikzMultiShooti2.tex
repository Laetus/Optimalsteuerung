...
%\addplot+[dashed,blue] coordinates {(.1,0) (.1, 1)};
%\addplot+[dashed,blue] coordinates {(.3,0) (.3, 1.3)};
%\addplot+[dashed,blue] coordinates {(.5,0) (.5, 1.5)};
%\addplot+[dashed,blue] coordinates {(.7,0) (.7, 1.25)};
%\addplot+[dashed,blue] coordinates {(.9,0) (.9, 1.1)};
\end{axis}										
\end{tikzpicture}