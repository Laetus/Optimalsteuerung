\begin{tikzpicture}[]
\begin{groupplot}[group style={group size=2 by 1, horizontal sep=.2cm}, height=.5\textwidth, width=.6\textwidth, use units]
\nextgroupplot[
		xtick = {0.1,.3,0.5,0.7,0.9},
		ytick = {0},
		xlabel = {\tiny$t$},
		ylabel = {\tiny$\widetilde u(t)$},
		yticklabels={},
		xticklabels={\tiny$t_{i}$,\tiny$t_{i+1}$,\tiny$t_{i+2}$,\tiny$t_{i+3}$,\tiny$t_{i+4}$}
]
\addplot+[mark=*,only marks] coordinates {(.1,.3) (.3,.2) (.5,.15) (.7,.25) (.9,.2)};
\addplot+[dashed] coordinates {(0,.25) (.1, .25)};
\addplot+[solid] coordinates {(.1,.3) (.3, .3)};
\addplot+[solid] coordinates {(.3,.2) (.5, .2)};
\addplot+[solid] coordinates {(.5,.15) (.7, .15)};
\addplot+[solid] coordinates {(.7,.25) (.9, .25)};
\addplot+[dashed] coordinates {(.9,.2) (1.1, .2)};

\addplot+[dashed] coordinates {(.1,0) (.1, .3)};
\addplot+[dashed] coordinates {(.3,0) (.3, .2)};
\addplot+[dashed] coordinates {(.5,0) (.5, .15)};
\addplot+[dashed] coordinates {(.7,0) (.7, .25)};
\addplot+[dashed] coordinates {(.9,0) (.9, .2)};
